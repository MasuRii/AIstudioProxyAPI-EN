...
MESSAGE_TEXTAREA_SELECTOR = "ms-chat-turn:last-child textarea, ms-chat-turn:last-child ms-text-chunk textarea"
...
THINKING_MODE_TOGGLE_PARENT_SELECTOR = 'mat-slide-toggle:has(button[aria-label="Toggle thinking mode"])'
THINKING_MODE_TOGGLE_OLD_ROOT_SELECTOR = 'mat-slide-toggle[data-test-toggle="enable-thinking"]'
...
THINKING_BUDGET_TOGGLE_OLD_ROOT_SELECTOR = 'mat-slide-toggle[data-test-toggle="manual-budget"]'
